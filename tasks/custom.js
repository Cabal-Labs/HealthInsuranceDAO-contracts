task("stable-diffusion", "Sends a prompt to stable diffusion running on Bacalhau.")
    ...
    .setAction(async (taskArgs) => {
        ...
        console.log("Testing", networkId)

        //create a new wallet instance
        const wallet = new ethers.Wallet(network.config.accounts[0], ethers.provider)

        //create a StableDiffusionCallerV2 contract factory
        const StableDiffusionCallerV2 = await ethers.getContractFactory(
            "StableDiffusionCallerV2",
            wallet
        )
